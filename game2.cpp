...
public:
    ...
    void combatLog(string action) {
        ...
        while (clock() < start_time + 500); // 模擬短暫延遲，增強沉浸感
    }
...
int main() {
    while (true) {
        ...
        cout << "my random game" << "\n";
        clock_t start_time = clock();
        while (clock() < start_time + 1000);  // 延遲 1000 毫秒（1 秒）
        cout << "random game" << "\n";
        start_time = clock();
        while (clock() < start_time + 1000);  // 延遲 1000 毫秒（1 秒）
        cout << "GAME";
        start_time = clock();
        while (clock() < start_time + 300);  // 延遲 1000 毫秒（1 秒）
        for(int i = 0; i < 3; i++){
            cout << ".";
            start_time = clock();
            while (clock() < start_time + 500);  // 延遲 1000 毫秒（1 秒）
        }
        cout << "START!!!" << "\n";
        cout << "\n";
        start_time = clock();
